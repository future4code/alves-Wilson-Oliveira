import { IDeletePostInputDTO, IAddLikeInputDTO, IRemoveLikeInputDTO } from './../src/models/Post';
...
describe("Testando a PostBusiness", () => {
    ...
    test("Deve ser possivel deletar um post", async () => {
    ...
    test("Deve ser possivel dar like em um post", async () => {
    ...
    test("Deve ser possivel retirar o like em um post", async () => {
